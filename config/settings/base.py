...
# Stripe Connect (invoice payouts) - enabled by default when STRIPE_SECRET_KEY is set.
STRIPE_CONNECT_ENABLED = _getenv_bool("STRIPE_CONNECT_ENABLED", True)
...
BACKUP_S3_BUCKET = _getenv("BACKUP_S3_BUCKET", "").strip()
