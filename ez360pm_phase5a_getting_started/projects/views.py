...
def project_files(request, pk):
    ...
    return render(
        ...
        {"project": project, "files": qs, "form": form, "dropbox_enabled": bool(getattr(getattr(company, "integration_config", None), "use_dropbox_for_project_files", False)), "dropbox_connected": bool(getattr(getattr(company, "dropbox_connection", None), "is_active", False))},
    )
