...
class TimeEntryAdmin(IncludeSoftDeletedAdminMixin, admin.ModelAdmin):
...
class TimerStateAdmin(IncludeSoftDeletedAdminMixin, admin.ModelAdmin):
    list_display = ("company", "employee", "is_running", "started_at", "project")


@admin.register(TimeTrackingSettings)
class TimeTrackingSettingsAdmin(IncludeSoftDeletedAdminMixin, admin.ModelAdmin):
