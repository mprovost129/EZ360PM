...
# Media / file storage
# --------------------------------------------------------------------------------------
# Default: local filesystem (MEDIA_ROOT). Optional: S3 via django-storages if USE_S3=1.
...
AWS_DEFAULT_ACL = (_getenv("AWS_DEFAULT_ACL", "") or "").strip() or None
AWS_S3_SIGNATURE_VERSION = _getenv("AWS_S3_SIGNATURE_VERSION", "s3v4")
...
# Presigned POST expiry for direct-to-S3 uploads (seconds)
S3_PRESIGN_POST_EXPIRE_SECONDS = int(_getenv("S3_PRESIGN_POST_EXPIRE_SECONDS", "300") or "300")
...
BACKUP_STORAGE = _getenv("BACKUP_STORAGE", "host_managed").strip()  # e.g. host_managed, s3, local
