...
from .models import OpsAlertEvent, LaunchGateItem, BackupRun, BackupRestoreTest, ReleaseNote, StorageSmokeTest
...
@admin.register(StorageSmokeTest)
class StorageSmokeTestAdmin(admin.ModelAdmin):
    list_display = ("created_at", "kind", "ok", "message", "object_name")
    list_filter = ("kind", "ok", "created_at")
    search_fields = ("message", "object_name")
    readonly_fields = ("created_at",)
    ordering = ("-created_at",)
