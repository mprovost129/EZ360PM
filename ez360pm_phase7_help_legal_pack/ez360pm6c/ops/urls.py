...
urlpatterns = [
    ...
    path("storage/", views.ops_storage, name="storage"),
    path("storage/smoke/run/", views.ops_storage_smoke_run, name="storage_smoke_run"),
    path("storage/posture/toggle/", views.ops_storage_posture_toggle, name="storage_posture_toggle"),
