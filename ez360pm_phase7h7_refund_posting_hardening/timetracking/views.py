...
def timer_panel(request):
    ...
    timer_state, _ = TimerState.objects.get_or_create(company=company,
        can_manage_catalog=can_manage_catalog, employee=employee)
    ...
    return render(request, "timetracking/timer_panel.html", {"timer_state": timer_state, "form": form, "can_manage_catalog": can_manage_catalog})
