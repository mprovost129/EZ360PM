    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, storage=core.storages.PublicMediaStorage(), upload_to='company_logos/')),
                ...
                ('default_invoice_due_days', models.PositiveIntegerField(default=30, help_text='Default number of days until invoice due date (used when creating new invoices).')),
                ('default_estimate_valid_days', models.PositiveIntegerField(default=30, help_text='Default number of days an estimate/proposal remains valid (used when creating new documents).')),
                ('default_sales_tax_percent', models.DecimalField(decimal_places=3, default=Decimal('0.000'), help_text='Default sales tax percentage for guidance (does not automatically apply tax to line items).', max_digits=6)),
                ('default_line_items_taxable', models.BooleanField(default=False, help_text="Default 'Taxable' checkbox for new document line items.")),
