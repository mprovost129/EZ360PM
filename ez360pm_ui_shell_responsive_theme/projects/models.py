...
class Project(SyncModel):
    ...
    def __str__(self) -> str:
        num = (self.project_number or "").strip() or "—"
...
class ProjectService(SyncModel):
    ...
    def save(self, *args, **kwargs):
        # If a catalog item is selected, keep the name in sync for stable exports and UI.
        if self.catalog_item_id and not (self.name or "").strip():
