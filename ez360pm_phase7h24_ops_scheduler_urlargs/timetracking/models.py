...
class TimeTrackingSettings(SyncModel):
    ...
    # Timer UX defaults (persisted so timer selections survive TimerState recreation)
    last_project = models.ForeignKey(Project, null=True, blank=True, on_delete=models.SET_NULL, related_name="time_settings_last_project")
    last_service_catalog_item = models.ForeignKey(
        CatalogItem,
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
    ...
    last_service_name = models.CharField(max_length=200, blank=True, default="")
    last_note = models.TextField(blank=True, default="")
