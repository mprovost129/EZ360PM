...
## 2026-02-18 — Phase 9 — Company isolation must be a tested invariant
- Company context (active company selection + employee membership) is a launch-blocking security invariant.
